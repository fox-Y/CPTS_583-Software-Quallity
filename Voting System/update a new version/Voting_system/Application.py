...
class Application(Frame):
    ...
    def createWidget(self):
        ...
        self.db = m.connect(host="localhost", user="root", passwd="mysql98", db="election")
    ...
    def buttonClicklogin(self, master):
        ...
        if (self.flag == 0):
            ...
            self.cur.execute("SELECT * FROM results") #need database
            ...
            self.lhead2 = Label(self.finfo, text="AADHAR NUMBER", font=("", 12, ""), bg="white", fg="black")
            ...
            for row in self.rows:
                ...
                self.bstats = Button(self.finfo, text="STATS", width=5, height=1, font=("", 16, ""), bg="gold", fg="black",
                                activeforeground="white", activebackground="grey")
    ...
    def buttonClickcast(self):
        ...
        # need database
        self.cur.execute("Insert into results (name,age,gender,vote) Values(%s,%s,%s,%s,%s)",
                    (self.name, self.age, self.gender, self.vote))
